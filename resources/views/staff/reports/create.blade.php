  ...
  <div class="card-rt">
    ...
    <form method="POST" action="{{ route('staff.reports.store') }}" enctype="multipart/form-data">
      ...
      <div class="row g-3">
        ...
        <div class="col-md-4"><label class="flbl">Task / Subject</label><input type="text" class="fctrl" name="task_subject" value="{{ old('task_subject') }}" placeholder="e.g. PHP Batch, Class 10 Maths"/></div>
        ...
        <div class="col-md-8"><label class="flbl">Attachment (optional)</label><input type="file" class="fctrl" name="attachment"/></div>
