...
@section('content')
  ...
  <a class="bsave mb-4 d-inline-block" href="{{ route('staff.reports.create') }}"><i class="bi bi-plus-lg me-1"></i>Add Today's Report</a>
      ...
      <tbody>
        @forelse ($reports as $r)
          <tr>
            ...
            <td>
              @if ($r->isEditable())
                <a class="bghost" style="font-size:12px;padding:6px 10px" href="{{ route('staff.reports.edit', $r) }}"><i class="bi bi-pencil-fill"></i></a>
              @endif
            </td>
          </tr>
        @empty
