  ...
  @else
    <div class="row g-3">
      @foreach ($course->notes as $note)
        <div class="col-md-6 col-lg-4">
          <div class="card-rt d-flex align-items-center gap-3">
            ...
            <div class="d-flex gap-1 flex-shrink-0">
              ...
              <form method="POST" action="{{ route('franchise.courses.notes.destroy', [$course, $note]) }}" onsubmit="return confirm('Delete this note?')">
                @csrf @method('DELETE')
        ...
        @include('franchise.courses-note-modal', ['course' => $course, 'note' => $note, 'modalId' => 'editNote' . $note->id])
      @endforeach
    </div>
  @endif

  @include('franchise.courses-note-modal', ['course' => $course, 'note' => null, 'modalId' => 'addNote'])
@endsection
