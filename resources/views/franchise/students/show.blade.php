...
@section('content')
  ...
  <div class="d-flex justify-content-between align-items-center mb-4 flex-wrap gap-2">
    <a href="{{ route('franchise.students.index') }}" style="color:var(--muted);text-decoration:none;font-size:12px"><i class="bi bi-arrow-left me-1"></i>Back to My Students</a>
    <div class="d-flex gap-2">
      ...
      <a href="{{ route('franchise.students.id-card.view', $student) }}" target="_blank" class="bghost" style="text-decoration:none;font-size:12px;padding:8px 16px"><i class="bi bi-eye-fill me-1"></i>View ID Card</a>
      <a href="{{ route('franchise.students.id-card.download', $student) }}" class="bsave" style="text-decoration:none;font-size:12px;padding:8px 16px"><i class="bi bi-download me-1"></i>Download</a>
    </div>
  </div>
  ...
  <div class="card-rt mb-4">
    <div class="row g-3">
      ...
      <div class="col-12">
        <span style="font-size:11px;color:var(--muted);text-transform:uppercase">Enrolled Courses (with you)</span><br>
        @forelse ($courses as $c)
          <span class="badge-rt bg-pending" style="margin:2px 4px 0 0">{{ $c['course']->name }}</span>
        @empty
          <span style="font-size:13px;color:var(--muted)">Not enrolled in any of your courses.</span>
        @endforelse
      </div>
    </div>
  </div>
  ...
  <div class="row g-3 mb-4">
      ...
      <div class="modal fade" id="feePay{{ $e->id }}" tabindex="-1">
        <div class="modal-dialog">
          <div class="modal-content">
            ...
            <form method="POST" action="{{ route('franchise.enrollments.payments.store', $e) }}">
              @csrf
    ...
    @empty
      <div class="col-12"><p style="font-size:13px;color:var(--muted)">Not enrolled in any of your courses.</p></div>
    @endforelse
  </div>
    ...
    <div class="col-lg-6">
      <div class="card-rt">
        ...
        <div class="table-wrap"><table class="table-rt">
          <thead><tr><th>Course</th><th>Amount</th><th>Method</th><th>Status</th></tr></thead>
          <tbody>
