...
@section('content')
  ...
  @else
    @foreach ($course->assignments as $assignment)
      <div class="card-rt mb-3">
        <div class="d-flex justify-content-between align-items-start gap-3 mb-3">
          ...
          <div class="d-flex gap-2 flex-shrink-0">
            ...
            <form method="POST" action="{{ route('franchise.courses.assignments.destroy', [$course, $assignment]) }}" onsubmit="return confirm('Delete this assignment?')">
              @csrf @method('DELETE')
      ...
      @include('franchise.courses-assignment-modal', ['course' => $course, 'assignment' => $assignment, 'modalId' => 'editAssignment' . $assignment->id])
        ...
        <div class="modal fade" id="grade{{ $submission->id }}" tabindex="-1">
          <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
              ...
              <form method="POST" action="{{ route('franchise.courses.assignments.grade', [$course, $submission]) }}">
                @csrf
  ...
  @include('franchise.courses-assignment-modal', ['course' => $course, 'assignment' => null, 'modalId' => 'addAssignment'])
@endsection
