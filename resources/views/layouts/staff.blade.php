...
<aside class="sb" id="sb">
  <div class="sb-brand">
    <div class="d-flex align-items-center gap-2">
      ...
      <div><div class="t1">R-Tech Computer</div><div class="t2">Staff Dashboard</div></div>
    </div>
  </div>
  <nav class="sb-nav">
    <div class="nsec">Main</div>
    <a class="slink {{ request()->routeIs('staff.reports.*') ? 'act' : '' }}" href="{{ route('staff.reports.index') }}"><i class="bi bi-journal-text"></i>Daily Reports</a>
  ...
  <div class="sb-bot"><div class="uinfo"><div class="uav">{{ strtoupper(substr(auth()->user()->name, 0, 1)) }}</div><div><div class="un">{{ auth()->user()->name }}</div><div class="ur">Staff</div></div></div></div>
</aside>
