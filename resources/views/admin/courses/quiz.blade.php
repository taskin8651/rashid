...
@section('content')
  ...
  @else
    @foreach ($course->quizQuestions as $question)
      <div class="card-rt mb-3">
        <div class="d-flex justify-content-between align-items-start gap-3">
          ...
          <div class="d-flex gap-2 flex-shrink-0">
            ...
            <form method="POST" action="{{ route('admin.courses.quiz.destroy', [$course, $question]) }}" onsubmit="return confirm('Delete this question?')">
              @csrf @method('DELETE')
      ...
      @include('admin.courses.partials.quiz-modal', ['course' => $course, 'question' => $question, 'modalId' => 'editQuestion' . $question->id])
    @endforeach
  @endif

  @include('admin.courses.partials.quiz-modal', ['course' => $course, 'question' => null, 'modalId' => 'addQuestion'])
@endsection
