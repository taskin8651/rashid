      ...
      @foreach ($videos as $video)
        <tr>
          ...
          <td style="text-align:right;white-space:nowrap">
            ...
            <form method="POST" action="{{ route('admin.courses.videos.destroy', [$course, $video]) }}" onsubmit="return confirm('Delete this video? This cannot be undone.')" style="display:inline">
              @csrf @method('DELETE')
        ...
        <tr id="edit-{{ $video->id }}" class="video-edit-row" style="display:none">
          <td colspan="6">
            <form method="POST" action="{{ route('admin.courses.videos.update', [$course, $video]) }}" enctype="multipart/form-data" class="py-2 js-video-upload-form">
              @csrf
              <div class="row g-2">
