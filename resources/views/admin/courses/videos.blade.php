...
@section('content')
  ...
  <details class="card-rt mb-4">
    ...
    <form method="POST" action="{{ route('admin.courses.videos.store', $course) }}" enctype="multipart/form-data" class="mt-4">
      ...
      <p style="font-size:11px;color:var(--muted);margin-top:8px">MP4, WebM, OGG or MOV &middot; up to 95MB. Premium videos are stored privately — only enrolled students, the owning franchisee and admins can stream them.</p>
